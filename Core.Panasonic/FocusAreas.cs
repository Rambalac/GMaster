namespace GMaster.Core.Camera.Panasonic
{
    ...
    public class FocusAreas : IFocusAreas
    {
        ...
        public void AddBox(int x1, int y1, int x2, int y2, LumixFocusAreaType type, bool failed)
        {
        ...
        public class Box : IBox
        {
            ...
            internal Box(int x1, int y1, int x2, int y2, LumixFocusAreaType type, bool failed)
            {
                this.x1 = x1;
                this.y1 = y1;
                this.x2 = x2;
